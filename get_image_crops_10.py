...
counter = 0
corrupted = 0
with open('vggface2_disk1-02') as csvfile:
    for line in csvfile:
        print(counter)
        counter += 1
        print(line)
        ...
        cropped_file_name = '/mnt/nfs/scratch1/cmanjesh/data/VGGFaces2Cropped'+file_line.split('vggface2')[1]
        ...
        try:
            ...
            os.mkdir('/mnt/nfs/scratch1/cmanjesh/data/VGGFaces2Cropped/train/'+cropped_file_name.split('/')[8]+'/')
